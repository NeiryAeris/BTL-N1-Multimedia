...
class ImageSearchApp:
    def __init__(self, root):
        ...
        ttk.Button(control_frame, text="\U0001F527 Rebuild Index", command=self.rebuild_index_async).pack(side=tk.LEFT, padx=5, pady=5)
    ...
    def rebuild_index_async(self):
        thread = Thread(target=self.rebuild_index)
        thread.start()
    ...
    def rebuild_index(self):
        try:
            ...
            messagebox.showinfo("Rebuild Complete", "Feature extraction and KNN model rebuilding finished.")
